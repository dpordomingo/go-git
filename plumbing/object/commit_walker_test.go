...
func (s *CommitWalkerSuite) TestCommitBSFIteratorWithAsyncSeenExternal(c *C) {
	from := s.commit(c, s.Fixture.Head)

	seenExternal := map[plumbing.Hash]bool{}

	var commits []*Commit
	iter := NewCommitIterBSF(from, seenExternal, nil)
	...
	for {
		...
		if commit.Hash.String() == "1669dce138d9b841a518c64b10914d88f5e488ea" {
			seenExternal[plumbing.NewHash("a5b8b09e2f8fcb0bb99d3ccb0958157b40890d69")] = true
		}
	...
	expected := []string{
		...
		"1669dce138d9b841a518c64b10914d88f5e488ea",
		"35e85108805c84807bc66a02d91535e1e24b38b9",
		// "a5b8b09e2f8fcb0bb99d3ccb0958157b40890d69", // <- seenExternal
		"b029517f6300c2da0f4b651b8642506cd6aaf45d",
		// "b8e471f58bcbca63b07bda20e428190409c2db47", // <- omitted because of seenExternal
	}
